...
- (void)viewDidLoad {
    ...
    UILabel*sumtitle=[[UILabel alloc]initWithFrame:CGRectMake(10, 10, 100, 20)];
    sumtitle.backgroundColor=[UIColor clearColor];
    sumtitle.text=@"共10个微课";
    sumtitle.textColor=[UIColor grayColor];
    [self.view addSubview:sumtitle];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ShowPlayerViewController*playerview=[[ShowPlayerViewController alloc]init];
